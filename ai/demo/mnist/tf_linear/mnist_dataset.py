...
# 2. create datasets and iterator
train_data = tf.data.Dataset.from_tensor_slices(train)
train_data = train_data.shuffle(n_train)
...
writer = tf.summary.FileWriter('./graphs/mnist_dataset', tf.get_default_graph())
